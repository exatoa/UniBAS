...
public class Attachment {
	...
	public Attachment(int _attachID, String _desc,	String _filename, int _isObsolete, int _isPatch, int _isPrivate, int _isUrl,  String _creation_ts,  String _delta_ts, int _attacherID, String _attacher, String _mimeType, String _data, int _size) {
		ID = _attachID;
